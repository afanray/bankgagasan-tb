  ...
  <div class="hero-header overflow-hidden px-5">
    ...
    <div class="row gy-5 align-items-center">
      ...
      <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.2s">
        <img src="/colaboratif-tb.svg" class="img-fluid w-100 h-100" alt="" />
      </div>
    </div>
  </div>
          ...
          <a href="/sebaran">
            <div class="service-item text-center rounded p-4">
              <div
                class="service-icon d-inline-block bg-light rounded p-4 mb-4"
              >
                <i class="fa fa-map fa-5x text-primary"></i>
              </div>
          ...
          <a href="/">
            <div class="service-item text-center rounded p-4">
              <div
                class="service-icon d-inline-block bg-light rounded p-4 mb-4"
              >
                <i class="fa fa-syringe fa-5x text-primary"></i>
              </div>
          ...
          <a href="/">
            <div class="service-item text-center rounded p-4">
              <div
                class="service-icon d-inline-block bg-light rounded p-4 mb-4"
              >
                <i class="fa fa-rocket fa-5x" style="color: #ffd43b"></i>
              </div>
